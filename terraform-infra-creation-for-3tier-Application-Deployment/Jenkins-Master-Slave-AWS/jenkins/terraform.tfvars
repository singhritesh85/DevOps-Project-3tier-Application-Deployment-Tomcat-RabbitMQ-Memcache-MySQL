...
subnet_id = "subnet-07XXXXXXXXXXXXXa"
#vpc_security_group_ids = ["sg-00cXXXXXXXXXXXXX9"]
cidr_blocks = ["0.0.0.0/0"]
instance_type = [ "t3.micro", "t3.small", "t3.medium", "t3.large", "t3.xlarge" ]
name = "Jenkins"

kms_key_id = "arn:aws:kms:us-east-2:0XXXXXXXXX6:key/XXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXX"   ### Provide the ARN of KMS Key.
...
subnets = ["subnet-07XXXXXXXXXXXXXa", "subnet-0XXXXXXXXXXXXXXX7", "subnet-06XXXXXXXXXXXXXX2"]
...
certificate_arn = "arn:aws:acm:us-east-2:0XXXXXXXXXXXX6:certificate/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXX5"
